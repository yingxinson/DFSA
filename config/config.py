...
class DataProcessingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--depth_model', type=str, default="./asserts/depth.pth",
...
class DFSATrainingOptions():
    ...
    def parse_args(self):
        ...
        #self.parser.add_argument('--ref_channel', type=int, default=3, help='input reference image channels')
        ...
        self.parser.add_argument('--train_data', type=str, default=r"./asserts/training_data/training_json.json",
                            help='path of training json')
        self.parser.add_argument('--batch_size', type=int, default=96, help='training batch size')
        ...
        self.parser.add_argument('--lr_g', type=float, default=0.0001, help='initial learning rate for adam')  #0.0001
        self.parser.add_argument('--lr_dI', type=float, default=0.0001, help='initial learning rate for adam')  # 0.0001
